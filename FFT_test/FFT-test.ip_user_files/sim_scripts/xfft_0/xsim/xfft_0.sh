...
#
# Generated by Vivado on Mon Nov 03 13:07:05 +0330 2025
...
simulate()
{
  xsim xfft_0 -key {Behavioral:sim_1:Functional:xfft_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
