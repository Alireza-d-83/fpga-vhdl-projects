...
HD_PWD='D:/general/University/VHDL/project/BPSK/BPSK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBPSK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBPSK.tcl
